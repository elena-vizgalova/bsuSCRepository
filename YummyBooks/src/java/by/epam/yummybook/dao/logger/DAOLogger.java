package by.epam.yummybook.dao.logger;
...
public class DAOLogger {
   ...
   /**
    ...
    private DAOLogger( Class msgSender ) {
        ...
        try {
            String fileName = loggerPropertyManager.getProperty( 
                    LoggerPropertyManager.DAO_LOG_FILENAME );
            ...
            String loggerLevelStr = loggerPropertyManager.getProperty( 
                    LoggerPropertyManager.DAO_LOG_LEVEL );
    ...
    public static synchronized DAOLogger getInstance(Class msgSender) {
        if ( instance == null ) {
            instance = new DAOLogger( msgSender );
        }
        return instance;
    }
