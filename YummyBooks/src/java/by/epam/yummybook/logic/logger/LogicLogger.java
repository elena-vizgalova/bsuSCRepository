package by.epam.yummybook.logic.logger;
...
/**
 * Logger class for Logic classes.
 * @author Elena Vizgalova
 */
public class LogicLogger {
    private static LogicLogger instance;
    private static Logger logger;

   /**
     * Initializing <code>LogicLogger</code>.
     * Sets it's filename, level, <code>PatternLayout</code> with 
     * {@link LoggerPropertyManager#CONVERSION_PATTERN}
     * @param msgSender 
     */
    private LogicLogger( Class msgSender ) {
        ...
        try {
            String fileName = loggerPropertyManager.getProperty( 
                    LoggerPropertyManager.LOGIC_LOG_FILENAME );
            ...
            String loggerLevelStr = loggerPropertyManager.getProperty( 
                    LoggerPropertyManager.LOGIC_LOG_LEVEL );
    ...
    public static synchronized LogicLogger getInstance(Class msgSender) {
        if ( instance == null ) {
            instance = new LogicLogger( msgSender );
        }
        return instance;
    }
