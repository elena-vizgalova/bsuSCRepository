package by.epam.yummybook.entity.logger;
...
/**
 * Logger class for Entity classes.
...
public class EntityLogger {
   ...
   /**
    ...
    private EntityLogger( Class msgSender ) {
        ...
        try {
            String fileName = loggerPropertyManager.getProperty( 
                    LoggerPropertyManager.ENTITY_LOG_FILENAME );
            ...
            String loggerLevelStr = loggerPropertyManager.getProperty( 
                    LoggerPropertyManager.ENTITY_LOG_LEVEL );
    ...
    public static synchronized EntityLogger getInstance(Class msgSender) {
        if ( instance == null ) {
            instance = new EntityLogger( msgSender );
        }
        return instance;
    }
